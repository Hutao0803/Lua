...
if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
    ...
    do
        local ui = game.CoreGui:FindFirstChild("JerryXHUBMODILE")
        if ui then
            ui:Destroy()
        end
    end
    ...
    do
        local ui = game.CoreGui:FindFirstChild("Jerry Hub")
        if ui then
            ui:Destroy()
        end
    end
...
wait(1)
Notification:Notify(
   {Title = "Jerry Hub", Description = "Blox Fruit"},
...
wait(1)
Notification:Notify(
   {Title = "Jerry Hub", Description = "Loading . . ."},
   {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 5, Type = "option"},
   {Image = "http://www.roblox.com/asset/?id=6023426923", ImageColor = Color3.fromRGB(255, 84, 84), Callback = function(State) print(tostring(State)) end}
)
...
function Update:Window(text,logo,keybind)
	local uihide = false
	local abc = false
	local logo = logo or 14299284116
	local currentpage = ""
	local keybind = keybind or Enum.KeyCode.RightControl
	local yoo = string.gsub(tostring(keybind),"Enum.KeyCode.","")
	
	local JerryXHUB = Instance.new("ScreenGui")
	JerryXHUB.Name = "Jerry Hub"
	JerryXHUB.Parent = game.CoreGui
	JerryXHUB.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

	local Main = Instance.new("Frame")
	Main.Name = "Main"
	Main.Parent = JerryXHUB
	...
	Logo.Image = "rbxassetid://14299284116"
...
-- BodyClip
    ...
    spawn(function()
        ...
        local JerryXHUBMODILE = Instance.new("ScreenGui")
        local MODILEGUIJerryXHUB = Instance.new("TextButton")
        local MODILEGUIJerryXHUBHUI = Instance.new("UICorner")
        local MODILEMAGE = Instance.new("ImageLabel")
        JerryXHUBMODILE.Name = "JerryXHUBMODILE"
        JerryXHUBMODILE.Parent = game.CoreGui
        JerryXHUBMODILE.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
        MODILEGUIJerryXHUB.Name = "MODILEGUIJerryXHUB"
        MODILEGUIJerryXHUB.Parent = JerryXHUBMODILE
        MODILEGUIJerryXHUB.BackgroundColor3 = Color3.fromRGB(30,20,20)
        MODILEGUIJerryXHUB.BorderSizePixel = 0
        MODILEGUIJerryXHUB.Position = UDim2.new(0, 0, 0.491228074, 0)
        MODILEGUIJerryXHUB.Size = UDim2.new(0, 50, 0, 50)
        MODILEGUIJerryXHUB.Font = Enum.Font.SourceSans
        MODILEGUIJerryXHUB.Text = ""
        MODILEGUIJerryXHUB.TextColor3 = Color3.fromRGB(0, 0, 0)
        MODILEGUIJerryXHUB.TextSize = 14.000
        MODILEGUIJerryXHUB.Draggable = true
        MODILEGUIJerryXHUB.MouseButton1Click:Connect(function()
      ...
      game:GetService("VirtualInputManager"):SendKeyEvent(false,305,false,game)
        ...
        MODILEGUIJerryXHUBHUI.Name = "MODILEGUIJerryXHUBHUI"
        MODILEGUIJerryXHUBHUI.Parent = MODILEGUIJerryXHUB

        MODILEMAGE.Name = "MODILEMAGE"
        MODILEMAGE.Parent = MODILEGUIJerryXHUB
        ...
        MODILEMAGE.Image = "http://www.roblox.com/asset/?id=14299284116"
do
   ...
   spawn(function()
            while wait() do
                pcall(function()
                    wait(0.1) 
                    game:GetService('TweenService'):Create(
                        MODILEGUIJerryXHUB,TweenInfo.new(1,Enum.EasingStyle.Linear,Enum.EasingDirection.InOut),
                        {TextColor3 = Color3.fromRGB(255, 0, 0)}
                    ):Play() 
                    wait(.5)            
                    game:GetService('TweenService'):Create(
    ...
    local JerryUi = Update:Window("Jerry","",Enum.KeyCode.RightControl);
    local Main = JerryUi:Tab("Main Farm","6026568198")
    local AutoMisc = JerryUi:Tab("Misc Farm","4627130945")
    local Combat = JerryUi:Tab("Combat","7251993295")
    local Stats = JerryUi:Tab("Stats","7040410130")
    local Teleport = JerryUi:Tab("Teleport","6035190846")
    local Dungeon = JerryUi:Tab("Dungeon","7044284832")
    local DevilFruit = JerryUi:Tab("Devil Fruit","7044233235")
    local Shop = JerryUi:Tab("Shop","6031265976")
    local Misc = JerryUi:Tab("Misc","6034509993")
    local Check = JerryUi:Tab("Check","4458804262")
...
wait(1)
Notification:Notify(
   {Title = "Jerry Hub", Description = "Go to Grave"},
   {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 5, Type = "option"},
   {Image = "http://www.roblox.com/asset/?id=6023426923", ImageColor = Color3.fromRGB(255, 84, 84), Callback = function(State) print(tostring(State)) end}
)
...
wait(1)
Notification:Notify(
   {Title = "Jerry Hub", Description = "Wait Next Night"},
   {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 5, Type = "option"},
   {Image = "http://www.roblox.com/asset/?id=6023426923", ImageColor = Color3.fromRGB(255, 84, 84), Callback = function(State) print(tostring(State)) end}
)
									else
...
wait(1)
Notification:Notify(
   {Title = "Jerry Hub", Description = "You Have Max Observation"},
   {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 5, Type = "option"},
   {Image = "http://www.roblox.com/asset/?id=6023426923", ImageColor = Color3.fromRGB(255, 84, 84), Callback = function(State) print(tostring(State)) end}
)
                    else
...
Shop:Button("Random Race (Use 3K Fragments)", function()
  ...
  Misc:Button("Hop Lower Server",function()
    ...
    Misc:Button("Destroy Ui",function()
        if game.CoreGui:FindFirstChild("Jerry Hub") then
            game.CoreGui:FindFirstChild("Jerry Hub"):Destroy()
            game.CoreGui:FindFirstChild("JerryXHUBMODILE"):Destroy()
        end
    end)
...
wait(1)
Notification:Notify(
   {Title = "Welcome Jerry Hub", Description = "Sucessful"},
   {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 5, Type = "option"},
   {Image = "http://www.roblox.com/asset/?id=6023426923", ImageColor = Color3.fromRGB(255, 84, 84), Callback = function(State) print(tostring(State)) end}
)
end
...
wait(1)
Notification:Notify(
   {Title = "Jerry Hub", Description = "SCP 3008"},
   {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 5, Type = "option"},
   {Image = "http://www.roblox.com/asset/?id=6023426923", ImageColor = Color3.fromRGB(255, 84, 84), Callback = function(State) print(tostring(State)) end}
)
...
do
   ...
   spawn(function()
    ...
    local JerryUi = Update:Window("Jerry","",Enum.KeyCode.RightControl);
    local Main = JerryUi:Tab("Main","6026568198")
    local esp = JerryUi:Tab("Teleport","6035190846")
	local TP = JerryUi:Tab("Dungeon","7044284832")
    local Misc = JerryUi:Tab("Misc","6034509993")    
...
wait(1)
Notification:Notify(
   {Title = "Jerry Hub", Description = "Build A Boat For Treasure"},
   {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 5, Type = "option"},
   {Image = "http://www.roblox.com/asset/?id=6023426923", ImageColor = Color3.fromRGB(255, 84, 84), Callback = function(State) print(tostring(State)) end}
)
...
do
   ...
   spawn(function()
    ...
    local JerryUi = Update:Window("Jerry","",Enum.KeyCode.RightControl);
    local Main = JerryUi:Tab("Auto Farm","6026568198")
    local Teleport = JerryUi:Tab("Teleport","6035190846")
    local Misc = JerryUi:Tab("Misc","6034509993")    
