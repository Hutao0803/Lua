local KeyInPut = loadstring(game:HttpGet("https://raw.githubusercontent.com/KvdzUwU/TrashHub/main/Key.lua"))()
local CanRun = false
for i, v in pairs(KeyInPut) do
    if v == _G.Key then
        CanRun = true
...
AntiAFK()
local z = loadstring(game:HttpGet(("https://raw.githubusercontent.com/KvdzUwU/TrashHub/main/Mobile/Ui.lua")))()    
local W = z:MakeWindow({Name = "Jerry Hub", HidePremium = false, SaveConfig = true, ConfigFolder = "Jerry Hub"})

local MainTab = W:MakeTab({
	Name = "Main",
...
spawn(function()
	while wait() do
        local waterSize = _G.WalkWater and Vector3.new(1000, 112, 1000) or Vector3.new(1000, 80, 1000)
        game:GetService("Workspace").Map["WaterBase-Plane"].Size = waterSize
	end
end)
